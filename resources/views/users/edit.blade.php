            ...
            <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        <i class="fas fa-info-circle"></i> Si no desea cambiar la contraseña, deje este campo en blanco.
                                    </small>
                                </div>
                            </div>
                ...
                <div class="card-footer">
                    <div class="text-muted">
                        <small>
                            <i class="fas fa-info-circle"></i> Última actualización: {{ $user->updated_at->format('d/m/Y H:i') }}
                        </small>
                    </div>
                </div>
            </div>
